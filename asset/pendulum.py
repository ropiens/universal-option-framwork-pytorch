...
class PendulumEnv(gym.Env):
    ...
    def render_goal(self, goal, end_goal, mode="human"):
        ...
        if self.viewer is None:
            ...
            ################ goal ################
            rod1 = rendering.make_goal_circ(1, 0.1)
            rod1.set_color(0.8, 0.8, 0.3)
            ...
            ############## End Goal ##############
            rod2 = rendering.make_goal_circ(1, 0.1)
    ...
    def render_goal_2(self, goal1, goal2, end_goal, mode="human"):
        ...
        if self.viewer is None:
            ...
            ############### End Goal ###############
            rod3 = rendering.make_goal_circ(1, 0.1)
            rod3.set_color(0.3, 0.3, 0.8)
